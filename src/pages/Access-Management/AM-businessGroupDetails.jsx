...
import { Stack, Flex, Box, Text, Input, InputGroup, InputLeftElement, Link } from "@chakra-ui/react";
...
export default function AMBusinessGroupDetails({ name, pathValue }) {
                        ...
                        <Flex direction="column" ml="200" mt="150" p={'20px 25px'} gap={8}>
                            <Stack mt={"-60px"} direction={'row'} spacing={6}>
                                ...
                                <Text fontSize={14} color={'#747474'} fontWeight={500}>
                                    Business groups are isolated scopes for managing access. Users and teams may access resources in a business group through their permissions. <Link color={'#0176d3'} textDecoration={'underline'} href="https://docs.mulesoft.com/access-management/business-groups" target="_blank">Learn more</Link>
                                </Text>
