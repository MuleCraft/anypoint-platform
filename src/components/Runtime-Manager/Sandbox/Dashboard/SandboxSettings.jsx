import { Box, Button, ButtonGroup, Checkbox, Divider, Flex, FormControl, IconButton, Input, InputGroup, InputLeftElement, InputRightElement, Link, Menu, MenuButton, MenuItem, MenuList, Modal, ModalBody, ModalContent, ModalFooter, ModalHeader, ModalOverlay, Radio, RadioGroup, Stack, Tab, TabIndicator, TabList, TabPanel, TabPanels, Table, TableContainer, Tabs, Tbody, Td, Text, Th, Thead, Tr, VStack, useDisclosure } from '@chakra-ui/react';
import { FaCircle } from 'react-icons/fa';
import { useParams } from 'react-router-dom';
import SelectComponent from '../../../SelectComponent';
import { env, versions } from '../SelectMenuDatas/DeploymentTarget';
...
export const SandboxSetting = ({ name }) => {
