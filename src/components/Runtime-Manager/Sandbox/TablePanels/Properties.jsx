        ...
        <>
            <Box p={4}>
                ...
                {view === 'table' ? (
                    ...
                    <Box pt={4} backgroundColor="white">
                        <Textarea variant="custom" bgColor="#f4f5f6" value="anypoint.platform.config.analytics.agent.enabled=true" borderRightColor={"#cacbcc "} borderRightWidth={3} borderLeftColor={"#cacbcc "} borderLeftWidth={3} size='sm' height="200px" />
                    </Box>
                )}
            </Box>
