import { VStack,HStack,IconButton,Image,Link,Text,Flex,Avatar, Spacer } from "@chakra-ui/react";
...
export default function PageHeader(){
    ...
    return(
        <Flex as="nav" direction={'column'}
            ...
            zIndex={2} boxShadow={'rgba(17, 17, 26, 0.3) 0px 1px 0px;'}
        >
                ...
                <HStack h={'56px'} display={'flex'} justifyContent={'space-between'} p={'0px 16px'}>
                    <HStack maxW={'270px'}>
                        <IconButton variant={'text'} icon={<CiMenuBurger/>}
                            fontSize={'20px'} onClick={handleDrawerOpen}
