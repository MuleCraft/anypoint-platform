    ...
    const handleEmailSubmit = async () => {
        ...
        try {
            ...
            if (authError) {
                ...
                console.log("Email is not conformed");
                toast({
                    ...
                    <Modal isOpen={isOpen} onClose={onClose} isCentered size="xl">
                        ...
                        <ModalContent>
                            <Box bg="modelColor" borderRadius="4px">
                                <ModalHeader fontSize="lg" fontWeight="800">Confirm Change of Email</ModalHeader>
                            </Box>
                            <Divider />
                            <ModalBody>
                                <Text py={3} fontWeight="600" maxW="450px" fontSize="sm" color="#000" textAlign="center">
