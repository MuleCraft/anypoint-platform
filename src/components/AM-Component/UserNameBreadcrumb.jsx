...
import { Menu, MenuButton, MenuList, MenuItem, IconButton, Text, BreadcrumbItem, BreadcrumbLink, Heading, Checkbox, Breadcrumb, Divider, Table, Thead, Tr, Th, Tbody, Td, Box, Flex } from '@chakra-ui/react';
            ...
            <Flex alignItems="center" justifyContent="space-between">
                ...
                <Menu>
                    ...
                    <MenuList borderRadius={0}>
                        ...
                        <MenuItem fontSize="sm" isDisabled>Reset Multi-factor auth...</MenuItem>
                        <MenuItem fontSize="sm" color="red">Disable user...</MenuItem>
                        <MenuItem fontSize="sm" color="red">Delete user...</MenuItem>
                    </MenuList>
                </Menu>
            </Flex>
            <Box>
                <FlexableTabs
                    ...
                    onItemSelect={itemName => setActiveItem(itemName)}
                />
            </Box>
            <Box mt={10}>
                ...
                <Flex direction="column" gap={5} m={10}>
                    <Flex direction="row" maxW="800px" justifyContent="space-between" textAlign="left">
                        <Text fontSize="xs">Username</Text>
                        <Text fontSize="xs">{user?.user_metadata.full_name}</Text>
                        <Box>
                            <PiPencilLight />
                    ...
                    <Flex direction="row" maxW="415px" justifyContent="space-between" textAlign="left">
                        <Text fontSize="xs">Exempt from MFA requirement</Text>
                        <Checkbox isDisabled />
                    </Flex>
                </Flex>
                <Divider />
                <Flex direction="column" gap={5} m={10} textAlign="left">
