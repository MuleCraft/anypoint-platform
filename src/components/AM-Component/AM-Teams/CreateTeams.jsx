...
const CreateTeams = ({ filteredTeamsTableData, orgId, isOpen, onOpen, onClose, fetchTeams }) => {
    ...
    }, [filteredTeamsTableData, parentTeamName]);
    ...
    async function invokeTeamsCreate() {
        try {
            const response = await createNewTeams(teamsCreateParams, fetchTeams);
            onClose();
            ...
            if (response === "Error occurred!") {
                ...
                fetchTeams(); // Fetch teams after successful creation
            }
        } catch (error) {
        ...
        <>
            ...
            <Modal isOpen={isOpen} onClose={onClose} isCentered size="lg">
                ...
                <ModalContent>
                    ...
                    <Divider />
                    <ModalBody>
                        <FormControl id="team-name" p={4}>
                            <FormLabel fontWeight={500} fontSize={14} color={'#444444'}>
                                Name
                            </FormLabel>
                            ...
                            <InputGroup mt={1} zIndex={3}>
                                <InputRightElement pointerEvents="none" children={<SlArrowDown />} color="gray.500" />
                                <Input
                                    autoComplete="off"
                                    fontSize={14}
                                    color={'#747474'}
